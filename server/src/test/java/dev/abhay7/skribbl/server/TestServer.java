...
//             case LOBBY_JOIN:
//                 return LobbyJoinPack.fromJSON(innerDataString);
//             case LOBBY_LIST:
...
//                         break;
//                     }
//                 } else if(serverResponse instanceof LobbyJoinPack) {
//                     LobbyJoinPack jlp = (LobbyJoinPack) serverResponse;
...
//                         LobbyJoinPack jlp = new LobbyJoinPack(name, "Public Lobby");
